...
export function Row({row, setOrders, orders}) {
    ...
    async function newStatusOrder(id, status) {
        ...
        try {
            ...
            //achama a api para atualizar o status do pedido
            await api.put(`/orders/${id}`, {status});

            // Atualiza o estado local com o novo status
            const newOrders = orders.map( order => order._id === id
                ? {...order, status} //espalha o objeto e atualiza o status
                : order
            )
            setOrders(newOrders);
    ...
    return (
        <>
            <TableRow sx={{ '& > *': { borderBottom: 'unset' } }}>
                ...
                <TableCell>
                    {/* find busca alguma coisa dentro do array */}
                    <SelectStatus
                    ...
                    isLoading={loading}
                    menuPortalTarget={document.body} //corrige o problema do menu do select não abrir por completo
                    />
                </TableCell>
            </TableRow>
            <TableRow>
